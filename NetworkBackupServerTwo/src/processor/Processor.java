		...
		////////encrypt
            ...
            while (true) {
                ...
                if ("full".equals(stringgetContentType)){
	                //tobj.getFileName();
	                FileOutputStream fo = new FileOutputStream("C:/test/server2/" + stringgetFileName);
                ...
                if ("partial".equals(stringgetContentType)){
                	...
                	String deltaPath = "C:/test/server2_delta/"  + stringgetFileName;
                	FileOutputStream fo = new FileOutputStream(deltaPath);
	                fo.write(bytegetFileContent);                
	                fo.close();
	                
	                String source = "C:/test/server2/" + stringgetFileName;
	                String target = "C:/test/server2_tmp/" + stringgetFileName;
					...
					// There are problems with file handling, because the XDeltaEncoder is holding the files. 
                ...
                if ("##DELETE##".equals(stringgetMessage)) {
                	...
                	// delete the file
                	Path p = Paths.get("C:/test/server2/" + stringgetFileName);
                	Files.delete(p);
                }
                in.close();
            }
